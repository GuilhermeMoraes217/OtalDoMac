...
public class EmpresaDAO {
    ...
    public void salvar(Empresa empresa){
        ...
        cv.put(DbHelper.COLUNA_TEMPO_MINIMO, empresa.getTempMinEntrega());
        cv.put(DbHelper.COLUNA_TEMPO_MAXIMO, empresa.getTempMaxEntrega());
    ...
    public Empresa getEmpresa(){
        ...
        while (cursor.moveToNext()){
            ...
            empresa.setTempMinEntrega(tempo_minimo);
            empresa.setTempMaxEntrega(tempo_maximo);
