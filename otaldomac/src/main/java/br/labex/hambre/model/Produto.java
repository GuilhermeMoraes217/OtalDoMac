...
public class Produto implements Serializable {
    ...
    public Produto() {
        ...
        setId(produtoRef.push().getKey()); // GERA O ID AUTOMÁTICO DO PRUDUTO
    ...
    public void remover(){
        DatabaseReference produtoRef = FirebaseHelper.getDatabaseReference() // METODO DE DELEGAR O PRODUTO DO NÓ
                .child("produtos")
                .child(FirebaseHelper.getIdFirebase())
                .child(getId());
        ...
        StorageReference storageReference = FirebaseHelper.getStorageReference() // METODO DE DELEGAR O A IMAGEM DO PRODUTO DO NÓ
                .child("imagens")
                .child("produtos")
                .child(FirebaseHelper.getIdFirebase())
                .child(getId() + ".JPEG");
