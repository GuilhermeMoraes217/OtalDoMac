...
public class EmpresaProdutosDetalhesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empresa_produtos_detalhes);
    ...
    private void addItemCarrinho(){
        if(empresaDAO.getEmpresa() != null){
            if(produto.getIdEmpresa().equals(empresaDAO.getEmpresa().getId())){ // VERIFICANDO SE O ID DA EMPRESA É O MESMO ID COM O PRODUTO ADICIONADO AO CARRINHO
                salvarProduto();
            }else {
    ...
    private void recuperaEmpresa(){
        ...
        empresaRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                text_tempo_entrega.setText(empresa.getTempMinEntrega() + "-" + empresa.getTempMaxEntrega() + " min");
            }
