...
public class UsuarioFormEnderecoActivity extends AppCompatActivity {
    ...
    private void validaDados() {
        //String numero = edt_Numero.getText().toString().trim();
    ...
    private void configDados() {
        ...
        //edt_Numero.setText(endereco.getNumero());
    ...
    private void iniciaComponentes() {
        ...
        edt_logradouro = findViewById(R.id.edt_logradouroUsuario);
        //edt_Numero = findViewById(R.id.edt_Numero);
        edt_bairro = findViewById(R.id.edt_bairroUsuario);
        edt_municipio = findViewById(R.id.edt_municipioUsuario);
        edt_referencia = findViewById(R.id.edt_referenciaUsuario);
