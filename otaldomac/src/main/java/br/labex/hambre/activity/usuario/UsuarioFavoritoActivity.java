...
public class UsuarioFavoritoActivity extends AppCompatActivity implements EmpresasAdapter.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usuario_favorito);
